...
class AbLineMultiColor extends SampleView {
  ///Renders line series with point color mapping
  const AbLineMultiColor(Key key) : super(key: key);

  @override
  _AbLineMultiColorState createState() => _AbLineMultiColorState();
}

class _AbLineMultiColorState extends SampleViewState {
  _AbLineMultiColorState();
  ...
  SfCartesianChart _getMultiColorLineChart() {
    return SfCartesianChart(
      title: ChartTitle(text: false ? '' : 'AbNormal Level'),
  ...
  List<LineSeries<_ChartData, DateTime>> _getMultiColoredLineSeries() {
    final List<_ChartData> chartData = <_ChartData>[
      _ChartData(DateTime(1),4, const Color.fromRGBO(248, 184, 131, 1)),
      _ChartData( DateTime(2),4, const Color.fromRGBO(229, 101, 144, 1)),
      _ChartData( DateTime(3),3, const Color.fromRGBO(53, 124, 210, 1)),
      _ChartData( DateTime(4),3, const Color.fromRGBO(0, 189, 174, 1)),
      _ChartData( DateTime(5),2, const Color.fromRGBO(248, 184, 131, 1)),
